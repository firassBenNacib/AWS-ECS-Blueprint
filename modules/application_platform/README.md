...
| backend_task_cpu_architecture | Fargate CPU architecture for the backend task definition. | `string` | `"ARM64"` | no |
...
| rds_engine_version | RDS engine version for the workload MySQL instance. | `string` | `"8.4.8"` | no |
