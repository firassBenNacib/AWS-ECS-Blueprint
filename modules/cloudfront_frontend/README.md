...
| frontend_bucket_domain | S3 bucket domain name | `string` | n/a | yes |
| frontend_cert_arn | ACM certificate ARN for frontend | `string` | n/a | yes |
| secondary_bucket_domain | DR S3 bucket domain name used as secondary origin for CloudFront failover | `string` | n/a | yes |
