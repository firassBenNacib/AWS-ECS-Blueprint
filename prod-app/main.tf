...
module "app" {
  ...
  aws_assume_role_arn          = local.prod_role_arn_effective
  us_east_1_assume_role_arn    = local.prod_us_east_1_role_arn_effective
  dr_assume_role_arn           = local.prod_dr_role_arn_effective
  aws_assume_role_external_id  = var.assume_role_external_id
  aws_assume_role_session_name = "terraform-prod-app"
